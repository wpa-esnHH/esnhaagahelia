        ...
        <div>
            <div className="photo-text-box">
                ...
                <div className="text-container">
                    ...
                    <p>We organize various trips and events for the incoming exchange students. ESN Haaga-Helia co-operates closely with Haaga-Helia International Services and Haaga-Helia's international tutors. Outside of Haaga-Helia we co-operate with other schools in the Helsinki area. Through our membership in ESN (Erasmus Student Network) we strongly co-operate with Helsinki University, Laurea University of Applied Sciences, Aalto University, Metropolia University of Applied Sciences and several other universities around Finland as well as internationally.</p>
                    <h2>How does ESN Haaga-Helia works</h2>
                    <p>ESN Haaga-Helia is run in an open and democratic way. We have an elected board, each member with their own area of responsibility. Board together with a team of active members runs the everyday activities of ESN Haaga-Helia. Everyone who takes part in the running of ESN Haaga-Helia is a volunteer and not paid for their work. Board members are elected mainly for one calendar year in the end of the autumn semester. Nevertheless, board members can also be elected during the year if needed.</p>
